...
app.post('/', (req, res) => {
  ...
  data.push(req.body)
  console.log(data[0])
  createBox( parseFloat(data[0].width), parseFloat(data[0].long), parseFloat(data[0].height), parseFloat(data[0].tickness), parseFloat(data[0].smallsides), parseFloat(data[0].arround))
  res.sendStatus(200)
})
